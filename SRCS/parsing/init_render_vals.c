...
/*   Updated: 2025/12/30 21:35:19 by jchuah           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_render_vals(t_render_vals *render_vals)
{
	...
	render_vals->view_plane_len = tan(DFL_FOV * M_PI / 360);
	render_vals->projection_dist = IMG_WIDTH / 2 / render_vals->view_plane_len;
	render_vals->min_wall_height
		= round(render_vals->projection_dist / DFL_VIEW_DIST);
}
